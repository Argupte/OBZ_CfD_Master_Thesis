...
p_domain_matrix = Matrix(p_domain)  # Convert JuMP container to plain matrix
df = DataFrame(p_domain_matrix, :auto)     # Now wrap in DataFrame

CSV.write("E:/TU Delft/Thesis/Code/Results/case_study/p_domain.csv", df)